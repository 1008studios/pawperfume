						...
						<tr class:selected={selectedIds.has(order.id)}>
							...
							<td class="actions-col">
								<div class="row-actions">
									<button class="btn-icon" onclick={() => editOrder(order)} title="Edit"></button>
									<button class="btn-icon danger" onclick={() => deleteOrder(order.id)} title="Delete"></button>
								</div>
							</td>
						</tr>
					{:else}
	...
	<div class="modal-overlay" onclick={e => e.target === e.currentTarget && (editingOrder = null)} role="presentation">
		<div class="modal">
			<div class="modal-header">
				...
				<button class="btn-icon" onclick={() => editingOrder = null}></button>
			</div>
...
{#if showDeleteConfirm}
	<div class="modal-overlay" onclick={() => showDeleteConfirm = false} role="presentation">
		<div class="modal modal-sm">
			<div class="modal-header">
				<h3>Delete Order?</h3>
				<button class="btn-icon" onclick={() => showDeleteConfirm = false}></button>
			</div>
